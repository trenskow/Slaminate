        ...
        for propertyInfo in propertyInfos {
            ...
            if let value = propertyInfo.toValue {
                ...
                if LayerAnimation.canAnimate(propertyInfo.object, key: propertyInfo.key) {
                    animation = LayerAnimation(duration: applyDuration, object: propertyInfo.object, key: propertyInfo.key, toValue: value, curve: applyCurve)
                }
                
                else if ConstraintConstantAnimation.canAnimate(propertyInfo.object, key: propertyInfo.key) {
                    animation = ConstraintConstantAnimation(duration: applyDuration, object: propertyInfo.object, key: propertyInfo.key, toValue: value, curve: applyCurve)
                }
                    
                else if DirectAnimation.canAnimate(propertyInfo.object, key: propertyInfo.key) {
                    animation = DirectAnimation(duration: applyDuration, object: propertyInfo.object, key: propertyInfo.key, toValue: value, curve: applyCurve)
                }
