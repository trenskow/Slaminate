...
protocol Interpolatable {
    ...
    func interpolate(_ to: Interpolatable, _ position: Double) -> Interpolatable
...
extension Bool: Interpolatable {
    ...
    var objectValue: AnyObject? { return NSNumber(value: self as Bool) }
}
...
extension Double: Interpolatable {
    ...
    var objectValue: AnyObject? { return NSNumber(value: self as Double) }
}
...
extension Float: Interpolatable {
    ...
    var objectValue: AnyObject? { return NSNumber(value: self as Float) }
}
...
extension CGFloat: Interpolatable {
    ...
    var objectValue: AnyObject? { return NSNumber(value: Double(self) as Double) }
}
...
private struct Quaternion: Equatable, Interpolatable {
    ...
    var z: CGFloat = 0.0
    var w: CGFloat = 0.0
    fileprivate func interpolate(_ to: Interpolatable, _ position: Double) -> Interpolatable {
        return Quaternion(
    ...
    func interpolate(_ to: Interpolatable, _ position: Double) -> Interpolatable {
        ...
        if let to = to as? NSNumber, let from = self as? NSNumber {
            if from.typeEncoding == "c" && to.typeEncoding == "c" {
                return NSNumber(value: from.boolValue.interpolate(to.boolValue, position) as! Bool as Bool)
            }
            if from.typeEncoding != "d" || to.typeEncoding != "d" {
                return NSNumber(value: from.doubleValue.interpolate(to.doubleValue, position) as! Double as Double)
            }
        }
        ...
        case "d":
            ...
            return NSNumber(value: val as! Double as Double)
        case "{CGPoint=dd}":
